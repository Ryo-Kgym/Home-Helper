...
export const UsePointPresenter:
    FC<UsePointPresenterProps> = (props) => {
    ...
    return (
        <Box>
            <Table striped highlightOnHover>
                ...
                <tbody>{props.exchangeItems.map((exchangeItem) => (
