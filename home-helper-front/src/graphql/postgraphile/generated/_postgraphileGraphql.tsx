...
export type Application = Node & {
  ...
  /** Reads and enables pagination through a set of `GroupApplication`. */
  groupApplicationsByApplicationIdList: Array<GroupApplication>;
  /** A globally unique identifier. Can be used in various places throughout the system to identify this single value. */
  nodeId: Scalars["ID"];
...
export type ApplicationGroupApplicationsByApplicationIdListArgs = {
  condition?: InputMaybe<GroupApplicationCondition>;
  filter?: InputMaybe<GroupApplicationFilter>;
  first?: InputMaybe<Scalars["Int"]>;
  offset?: InputMaybe<Scalars["Int"]>;
  orderBy?: InputMaybe<Array<GroupApplicationsOrderBy>>;
};
...
export type ApplicationCondition = {
  ...
  /** Checks for equality with the object’s `topUrl` field. */
...
export type ApplicationFilter = {
  ...
  /** Filter by the object’s `topUrl` field. */
  topUrl?: InputMaybe<StringFilter>;
  /** Filter by the object’s `validFlag` field. */
  validFlag?: InputMaybe<BooleanFilter>;
};
...
export enum ApplicationsOrderBy {
  ...
  PrimaryKeyAsc = "PRIMARY_KEY_ASC",
  PrimaryKeyDesc = "PRIMARY_KEY_DESC",
  TopUrlAsc = "TOP_URL_ASC",
  TopUrlDesc = "TOP_URL_DESC",
  ValidFlagAsc = "VALID_FLAG_ASC",
  ValidFlagDesc = "VALID_FLAG_DESC",
}
...
/** All input for the create `GroupApplication` mutation. */
export type CreateGroupApplicationInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The `GroupApplication` to be created by this mutation. */
  groupApplication: GroupApplicationInput;
};

/** The output of our create `GroupApplication` mutation. */
export type CreateGroupApplicationPayload = {
  __typename?: "CreateGroupApplicationPayload";
  /** Reads a single `Application` that is related to this `GroupApplication`. */
   ...
   */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** The `GroupApplication` that was created by this mutation. */
  groupApplication?: Maybe<GroupApplication>;
  /** Reads a single `Group` that is related to this `GroupApplication`. */
  groupByGroupId?: Maybe<Group>;
  /** Our root query field type. Allows us to run any query from our mutation payload. */
  query?: Maybe<Query>;
};
...
export type DeleteApplicationByApplicationIdInput = {
  applicationId: Scalars["UUID"];
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
...
/** All input for the `deleteGroupApplicationByGroupApplicationId` mutation. */
export type DeleteGroupApplicationByGroupApplicationIdInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
...
/** All input for the `deleteGroupApplication` mutation. */
export type DeleteGroupApplicationInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The globally unique `ID` which will identify a single `GroupApplication` to be deleted. */
  nodeId: Scalars["ID"];
};

/** The output of our delete `GroupApplication` mutation. */
export type DeleteGroupApplicationPayload = {
  __typename?: "DeleteGroupApplicationPayload";
  /** Reads a single `Application` that is related to this `GroupApplication`. */
  applicationByApplicationId?: Maybe<Application>;
  /**
   * The exact same `clientMutationId` that was provided in the mutation input,
   ...
   */
  clientMutationId?: Maybe<Scalars["String"]>;
  deletedGroupApplicationId?: Maybe<Scalars["ID"]>;
  /** The `GroupApplication` that was deleted by this mutation. */
  groupApplication?: Maybe<GroupApplication>;
  /** Reads a single `Group` that is related to this `GroupApplication`. */
  groupByGroupId?: Maybe<Group>;
  /** Our root query field type. Allows us to run any query from our mutation payload. */
...
export type Group = Node & {
  ...
  /** Reads and enables pagination through a set of `GroupApplication`. */
  groupApplicationsByGroupIdList: Array<GroupApplication>;
  groupId: Scalars["UUID"];
...
export type GroupGroupApplicationsByGroupIdListArgs = {
  condition?: InputMaybe<GroupApplicationCondition>;
  filter?: InputMaybe<GroupApplicationFilter>;
  first?: InputMaybe<Scalars["Int"]>;
  offset?: InputMaybe<Scalars["Int"]>;
...
export type GroupApplication = Node & {
...
/**
 * A condition to be used against `GroupApplication` object types. All fields are
 * tested for equality and combined with a logical ‘and.’
 */
export type GroupApplicationCondition = {
  /** Checks for equality with the object’s `applicationId` field. */
  applicationId?: InputMaybe<Scalars["UUID"]>;
  /** Checks for equality with the object’s `groupApplicationId` field. */
  groupApplicationId?: InputMaybe<Scalars["UUID"]>;
  /** Checks for equality with the object’s `groupId` field. */
  groupId?: InputMaybe<Scalars["UUID"]>;
};

/** A filter to be used against `GroupApplication` object types. All fields are combined with a logical ‘and.’ */
export type GroupApplicationFilter = {
  /** Checks for all expressions in this list. */
  and?: InputMaybe<Array<GroupApplicationFilter>>;
  /** Filter by the object’s `applicationId` field. */
  applicationId?: InputMaybe<UuidFilter>;
  /** Filter by the object’s `groupApplicationId` field. */
  groupApplicationId?: InputMaybe<UuidFilter>;
  /** Filter by the object’s `groupId` field. */
  groupId?: InputMaybe<UuidFilter>;
  /** Negates the expression. */
  not?: InputMaybe<GroupApplicationFilter>;
  /** Checks for any expressions in this list. */
  or?: InputMaybe<Array<GroupApplicationFilter>>;
};

/** An input for mutations affecting `GroupApplication` */
...
/** Represents an update to a `GroupApplication`. Fields that are set will be updated. */
export type GroupApplicationPatch = {
  applicationId?: InputMaybe<Scalars["UUID"]>;
  groupApplicationId?: InputMaybe<Scalars["UUID"]>;
  groupId?: InputMaybe<Scalars["UUID"]>;
};

/** Methods to use when ordering `GroupApplication`. */
export enum GroupApplicationsOrderBy {
  ApplicationIdAsc = "APPLICATION_ID_ASC",
  ApplicationIdDesc = "APPLICATION_ID_DESC",
  GroupApplicationIdAsc = "GROUP_APPLICATION_ID_ASC",
  GroupApplicationIdDesc = "GROUP_APPLICATION_ID_DESC",
  GroupIdAsc = "GROUP_ID_ASC",
  GroupIdDesc = "GROUP_ID_DESC",
  Natural = "NATURAL",
  PrimaryKeyAsc = "PRIMARY_KEY_ASC",
...
export type Mutation = {
  ...
  /** Creates a single `GroupApplication`. */
  createGroupApplication?: Maybe<CreateGroupApplicationPayload>;
  ...
  deleteApplicationByApplicationId?: Maybe<DeleteApplicationPayload>;
  ...
  /** Deletes a single `GroupApplication` using its globally unique id. */
  deleteGroupApplication?: Maybe<DeleteGroupApplicationPayload>;
  /** Deletes a single `GroupApplication` using a unique key. */
  deleteGroupApplicationByGroupApplicationId?: Maybe<DeleteGroupApplicationPayload>;
  ...
  updateApplicationByApplicationId?: Maybe<UpdateApplicationPayload>;
  ...
  /** Updates a single `GroupApplication` using its globally unique id and a patch. */
  updateGroupApplication?: Maybe<UpdateGroupApplicationPayload>;
  /** Updates a single `GroupApplication` using a unique key and a patch. */
  updateGroupApplicationByGroupApplicationId?: Maybe<UpdateGroupApplicationPayload>;
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationCreateGroupApplicationArgs = {
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationDeleteApplicationByApplicationIdArgs = {
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationDeleteGroupApplicationArgs = {
  input: DeleteGroupApplicationInput;
};

/** The root mutation type which contains root level fields which mutate data. */
export type MutationDeleteGroupApplicationByGroupApplicationIdArgs = {
  input: DeleteGroupApplicationByGroupApplicationIdInput;
};
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationUpdateApplicationByApplicationIdArgs = {
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationUpdateGroupApplicationArgs = {
  input: UpdateGroupApplicationInput;
};

/** The root mutation type which contains root level fields which mutate data. */
export type MutationUpdateGroupApplicationByGroupApplicationIdArgs = {
  input: UpdateGroupApplicationByGroupApplicationIdInput;
};
...
export type Query = Node & {
  ...
  /** Reads a set of `GroupApplication`. */
  allGroupApplicationsList?: Maybe<Array<GroupApplication>>;
  ...
  group?: Maybe<Group>;
  /** Reads a single `GroupApplication` using its globally unique `ID`. */
  groupApplication?: Maybe<GroupApplication>;
  groupApplicationByGroupApplicationId?: Maybe<GroupApplication>;
  groupByGroupId?: Maybe<Group>;
...
/** The root query type which gives access points into the data universe. */
export type QueryAllGroupApplicationsListArgs = {
  condition?: InputMaybe<GroupApplicationCondition>;
  filter?: InputMaybe<GroupApplicationFilter>;
  first?: InputMaybe<Scalars["Int"]>;
  offset?: InputMaybe<Scalars["Int"]>;
...
/** The root query type which gives access points into the data universe. */
export type QueryApplicationByApplicationIdArgs = {
  applicationId: Scalars["UUID"];
};
...
/** The root query type which gives access points into the data universe. */
export type QueryGroupApplicationArgs = {
  nodeId: Scalars["ID"];
};

/** The root query type which gives access points into the data universe. */
export type QueryGroupApplicationByGroupApplicationIdArgs = {
  groupApplicationId: Scalars["UUID"];
};
...
export type UpdateApplicationByApplicationIdInput = {
  applicationId: Scalars["UUID"];
...
/** All input for the `updateGroupApplicationByGroupApplicationId` mutation. */
export type UpdateGroupApplicationByGroupApplicationIdInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  groupApplicationId: Scalars["UUID"];
  /** An object where the defined keys will be set on the `GroupApplication` being updated. */
  groupApplicationPatch: GroupApplicationPatch;
};

/** All input for the `updateGroupApplication` mutation. */
export type UpdateGroupApplicationInput = {
  /**
   * An arbitrary string value with no semantic meaning. Will be included in the
   * payload verbatim. May be used to track mutations by the client.
   */
  ...
  /** An object where the defined keys will be set on the `GroupApplication` being updated. */
  groupApplicationPatch: GroupApplicationPatch;
  /** The globally unique `ID` which will identify a single `GroupApplication` to be updated. */
  nodeId: Scalars["ID"];
};

/** The output of our update `GroupApplication` mutation. */
export type UpdateGroupApplicationPayload = {
  __typename?: "UpdateGroupApplicationPayload";
  /** Reads a single `Application` that is related to this `GroupApplication`. */
  applicationByApplicationId?: Maybe<Application>;
  /**
   * The exact same `clientMutationId` that was provided in the mutation input,
   ...
   */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** The `GroupApplication` that was updated by this mutation. */
  groupApplication?: Maybe<GroupApplication>;
  /** Reads a single `Group` that is related to this `GroupApplication`. */
  groupByGroupId?: Maybe<Group>;
  /** Our root query field type. Allows us to run any query from our mutation payload. */
