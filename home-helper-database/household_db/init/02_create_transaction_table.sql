...
CREATE TABLE daily_detail (
    ...
    CONSTRAINT daily_detail_genre_fk FOREIGN KEY (genre_id) REFERENCES genre (genre_id),
...
CREATE TABLE credit_card_detail (
    ...
    CONSTRAINT credit_card_detail_genre_fk FOREIGN KEY (genre_id) REFERENCES genre (genre_id),
