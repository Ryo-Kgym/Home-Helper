...
create table daily_detail (
    ...
    constraint daily_detail_category foreign key (category_id) references m_category (category_id),
    constraint daily_detail_account foreign key (account_id) references m_account (account_id),
    constraint daily_detail_user foreign key (user_id) references m_user (user_id)
);
