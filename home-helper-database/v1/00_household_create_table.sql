...
create table public.group_role (
    group_role_id varchar(64) primary key not null,
...
create table public.application (
    application_id varchar(64) primary key not null,
...
create table public.group_application (
    group_application_id varchar(64) primary key not null,
...
create table public.affiliation (
    affiliation_id varchar(64) primary key not null,
    user_id        varchar(64)             not null,
    group_id       varchar(64)             not null,
    group_role_id  varchar(64)             not null,
    foreign key (group_id) references public."group" (group_id) match simple on update no action on delete no action,
...
create table public.category (
    category_id   varchar(64) primary key not null,
...
create table public.import_file_history (
    ...
    import_user_id  varchar(64)                 not null,
    group_id        varchar(64)                 not null,
    foreign key (group_id) references public."group" (group_id) match simple on update no action on delete no action,
...
create table public.transfer_category (
    group_id            varchar(64) primary key not null, -- グループID
    income_category_id  varchar(64)             not null, -- 収入カテゴリID
    outcome_category_id varchar(64)             not null, -- 支出カテゴリID
...
create table public.deposit_category (
    category_id varchar(64) primary key not null, -- カテゴリID
