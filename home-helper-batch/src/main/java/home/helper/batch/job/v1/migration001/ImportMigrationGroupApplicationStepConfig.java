...
public class ImportMigrationGroupApplicationStepConfig {
    ...
    public ItemReader<ImportMigrationGroupApplicationOutput> reader() {
        return itemReaderFactory.itemReaderV1Production(SelectMigrationGroupApplicationMapper.class, "selectMigrationGroupApplication");
    }
    ...
    public ItemWriter<ImportMigrationGroupApplicationOutput> writer(
        ...
        RegisterConvIdRepository<ImportMigrationGroupApplicationOutput> saveConvIdGateway
    ) {
        return new CompositeItemWriterBuilder<ImportMigrationGroupApplicationOutput>()
